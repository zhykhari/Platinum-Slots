Shader "Mkey/Sprites/Multiply"
{
	...
	SubShader
	{
		...
		//	#pragma multi_compile _ PIXELSNAP_ON
			...
			float Multiply(float base, float top)
			{
				return base * top;
			}
			...
			fixed4 ComputeFragment (VertexOutput vertexOutput) : SV_Target
			{
				...
				color.r = Multiply(grabColor.r, color.r);
				color.g = Multiply(grabColor.g, color.g);
				color.b = Multiply(grabColor.b, color.b);
				color.rgb *= color.a;
				return color;
			}
			ENDCG
